...
internal class _MemberFieldsEntityMetadata extends AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("Password", "FirstName", "RowID", "StartDate", "Company", "UserName", "DOB", "LastName");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Password", "FirstName", "RowID", "StartDate", "Company", "UserName", "DOB", "LastName");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Password", "FirstName", "RowID", "StartDate", "Company", "UserName", "DOB", "LastName");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Password", "FirstName", "RowID", "StartDate", "Company", "UserName", "DOB", "LastName");
