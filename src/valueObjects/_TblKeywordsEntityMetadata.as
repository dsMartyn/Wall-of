...
internal class _TblKeywordsEntityMetadata extends AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("RowID", "ProductID", "Keywords");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("RowID", "ProductID", "Keywords");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("RowID", "ProductID", "Keywords");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("RowID", "ProductID", "Keywords");
