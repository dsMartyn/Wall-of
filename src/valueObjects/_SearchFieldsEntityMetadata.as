...
internal class _SearchFieldsEntityMetadata extends AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("Image", "RowID", "count");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("Image", "RowID", "count");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("Image", "RowID", "count");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("Image", "RowID", "count");
